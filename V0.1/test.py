...
xys.set_starting_point([-0.26, 0.38, 138.3, 2, 0.5, 0])
# xys.set_starting_point([-0.3, -0.12, 138.6, 0, 0, 0])
# xys.set_limit_Z(139.118)
xys.set_limit_Z(140)
...
hppcontrol.normal_traj_speed()
file1 = open(r"pos.txt","w+")
file2 = open(r"loss.txt","w+")
a = xys.pos_rec[:]
b = xys.loss_rec[:]
