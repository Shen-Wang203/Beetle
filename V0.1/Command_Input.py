        ...
        if commands == 'start':
            ...
            for i in range(0, len(P)):
                ...
                if self.hppcontrol.safecheck(Tcounts):
                    ...
                    self.hppcontrol.send_counts(Tcounts, Tcounts_old)
                    Tcounts_old = Tcounts
                else:
                    error_flag = True
                    break
            ...
            Tcounts_old = self.hppcontrol.real_time_counts(0)
            self.hppcontrol.send_counts(T_reset, Tcounts_old)
            ...
            self.hppcontrol.engage_motor()
            target_counts = self.hppcontrol.run_to_Tmm(Tmm, Tcounts_old, 2)
            real_counts = control.Tcounts_real
